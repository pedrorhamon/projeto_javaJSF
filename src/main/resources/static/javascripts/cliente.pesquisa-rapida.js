...
Cerveja.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaConcluida(resultado) {
		...
		var tabelaClientePesquisaRapida = new Cerveja.TabelaClientePesquisaRapida(this.pesquisaRapidaClientesModal);
...
Cerveja.TabelaClientePesquisaRapida = (function() {
...
$(function() {
	var pesquisaRapidaCliente = new Cerveja.PesquisaRapidaCliente();
